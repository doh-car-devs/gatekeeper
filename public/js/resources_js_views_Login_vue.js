...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      axios.post('/api/auth', this.form_data).then(function (response) {
        console.log(response.data);

        _this.$store.dispatch('setToken', response.data);
...
var _hoisted_5 = {
  key: 0,
  "class": "text-red-500 bg-red-50 mx-8 my-4 p-2"
};
var _hoisted_6 = {
  "class": "flex flex-col px-8 pb-8"
};
var _hoisted_7 = {
  "class": "flex flex-col mb-4"
};

var _hoisted_8 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("label", null, "Username", -1
/* HOISTED */
);
...
var _hoisted_10 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("label", null, "Password", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("div", _hoisted_2, [_hoisted_3, _hoisted_4, $data.login_failed ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)("div", _hoisted_5, "Incorrect username or password.")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("form", {
    ...
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return $data.form_data.username = $event;
    }),
    "class": "px-2 py-1 border rounded"
  }, null, 512
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.form_data.username]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("div", _hoisted_9, [_hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("input", {
    type: "password",
    "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
      return $data.form_data.password = $event;
    }),
    "class": "px-2 py-1 border rounded"
  }, null, 512
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.form_data.password]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("button", {
    type: "submit",
    onClick: _cache[3] || (_cache[3] = function () {
      return $options.login && $options.login.apply($options, arguments);
    }),
    "class": "text-white bg-green-600 px-2 py-1 border rounded hover:bg-green-500 focus:bg-green-500"
  }, "Login")])])], 32
  /* HYDRATE_EVENTS */
  )])]);
}
